...
function systemInstruction(lang, places, cityContext, extra = {}) {
  ...
  const rules = [
    ...
    '  "Card link:" line, turn its name into a Markdown link to that exact path.',
    '  Copy the path VERBATIM from its "Card link:" line, INCLUDING the leading',
    '  slash. Correct: [Name](/events/<id>). WRONG: [Name](events/<id>) — a path',
    '  without the leading slash will not work. Never invent, alter or guess an id',
    '  or a path, and never link an item that has no "Card link:" line (markets',
    '  have none — do not link them). If you are unsure of the path, mention the',
    '  item without a link rather than making one up.',
